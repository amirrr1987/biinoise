                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <NuxtLink  to="/#"><img class="img-responsive" src="~/assets/images/product-image/2-1.jpg" alt="" /></NuxtLink>
                                                </td>
                                                <td class="product-name"><NuxtLink to="/#">Product Name</NuxtLink></td>
                                                ...
                                                <td class="product-remove">
                                                    <NuxtLink to="/#"><i class="icon-pencil"></i></NuxtLink>
                                                    <NuxtLink to="/#"><i class="icon-close"></i></NuxtLink>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <NuxtLink  to="/#"><img class="img-responsive" src="~/assets/images/product-image/2-2.jpg" alt="" /></NuxtLink>
                                                </td>
                                                <td class="product-name"><NuxtLink to="/#">Product Name</NuxtLink></td>
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <NuxtLink  to="/#"><img class="img-responsive" src="~/assets/images/product-image/2-3.jpg" alt="" /></NuxtLink>
                                                </td>
                                                <td class="product-name"><NuxtLink to="/#">Product Name</NuxtLink></td>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="cart-shiping-update-wrapper">
                                            ...
                                            <div class="cart-clear">
                                                ...
                                                <NuxtLink to="/#">Clear Shopping Cart</NuxtLink>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-12 mt-md-30px">
                                    <div class="grand-totall">
                                        ...
                                        <NuxtLink to="/#">Proceed to Checkout</NuxtLink>
                                    </div>
                                </div>
                            </div>
                        </div>
