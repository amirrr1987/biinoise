                            ...
                            <div class="single-product-gallery mb-30px">
                                <div class="single-product-slider-wrapper d-flex flex-wrap">
                                    <div class="single-product-slider-item">
                                        <NuxtLink to="/"><img class="img-responsive" src="~/assets/images/product-image/6.jpg" alt="slider-item-img"></NuxtLink>
                                    </div>
                                    <div class="single-product-slider-item swiper-slide">
                                        <NuxtLink to="/"><img class="img-responsive" src="~/assets/images/product-image/21.jpg" alt="slider-item-img"></NuxtLink>
                                    </div>
                                    <div class="single-product-slider-item swiper-slide">
                                        <NuxtLink to="/"><img class="img-responsive" src="~/assets/images/product-image/22.jpg" alt="slider-item-img"></NuxtLink>
                                    </div>
                                    <div class="single-product-slider-item swiper-slide">
                                        <NuxtLink to="/"><img class="img-responsive" src="~/assets/images/product-image/19.jpg" alt="slider-item-img"></NuxtLink>
                                    </div>
                                </div>
                            </div>
                        </div>
