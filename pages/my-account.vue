                                ...
                                <div id="faq" class="panel-group">
                                    <div class="panel panel-default single-my-account">
                                        <div class="panel-heading my-account-title">
                                            <h3 class="panel-title"><span>1 .</span> <NuxtLink data-bs-toggle="collapse" data-parent="#faq" to="/#my-account-1">Edit your account information </NuxtLink></h3>
                                        </div>
                                                ...
                                                <div class="myaccount-info-wrapper">
                                                    ...
                                                    <div class="billing-back-btn">
                                                        <div class="billing-back">
                                                            <NuxtLink to="/#"><i class="icon-arrow-up-circle"></i> back</NuxtLink>
                                                        </div>
                                    ...
                                    <div class="panel panel-default single-my-account">
                                        <div class="panel-heading my-account-title">
                                            <h3 class="panel-title"><span>2 .</span> <NuxtLink data-bs-toggle="collapse" data-parent="#faq" to="/#my-account-2">Change your password </NuxtLink></h3>
                                        </div>
                                    ...
                                    <div class="panel panel-default single-my-account">
                                        <div class="panel-heading my-account-title">
                                            <h3 class="panel-title"><span>3 .</span> <NuxtLink data-bs-toggle="collapse" data-parent="#faq" to="/#my-account-3">Modify your address book entries </NuxtLink></h3>
                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 d-flex align-items-center justify-content-center">
                                                                <div class="entries-edit-delete text-center">
                                                                    <NuxtLink class="edit" to="/#">Edit</NuxtLink>
                                    ...
                                    <div class="panel panel-default single-my-account">
                                        <div class="panel-heading my-account-title">
                                            <h3 class="panel-title"><span>4 .</span> <NuxtLink to="/wishlist">Modify your wish list </NuxtLink></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
