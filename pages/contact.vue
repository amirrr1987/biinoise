                    ...
                    <div class="contact-map mb-10">
                        <div class="mapouter">
                            <div class="gmap_canvas">
                                ...
                                <NuxtLink to="/https://sites.google.com/view/maps-api-v2/mapv2"></NuxtLink>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="contact-info-wrap">
                                <div class="single-contact-info">
                                    ...
                                    <div class="contact-info-dec">
                                        <p><NuxtLink to="/tel://0123456789">0123456789</NuxtLink></p>
                                        <p><NuxtLink to="/tel://0123456789">0123456789</NuxtLink></p>
                                    </div>
                                </div>
                                <div class="single-contact-info">
                                    ...
                                    <div class="contact-info-dec">
                                        <p><NuxtLink to="/mailto://urname@email.com">demo@example.com</NuxtLink></p>
                                        <p><NuxtLink to="/mailto://urwebsitenaem.com">demo@example.com</NuxtLink></p>
                                    </div>
                                </div>
                                <div class="single-contact-info">
                                    <div class="contact-icon">
                                ...
                                <div class="contact-social">
                                    ...
                                    <div class="social-info">
                                        <ul>
                                            ...
                                            <li>
                                                <NuxtLink to="/#"><i class="ion-social-youtube"></i></NuxtLink>
                                            </li>
                                            <li>
