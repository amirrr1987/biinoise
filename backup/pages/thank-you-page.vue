            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    <div class="header-logo">
                        <NuxtLink to="/"><img class="img-responsive" src="~/assets/images/logo/logo.png"
                                alt="logo.jpg" /></NuxtLink>
                    </div>
                </div>
                <!-- Header Logo End -->
                ...
                <div class="col-auto">
                    <div class="header-tools justify-content-end">
                        <div class="cart-info d-flex align-self-center">
                            <NuxtLink to="/compare" class="shuffle d-xs-none" data-number="3"><i
                                    class="icon-shuffle"></i></NuxtLink>
                            <NuxtLink to="/#offcanvas-wishlist" class="heart offcanvas-toggle d-xs-none" data-number="3"><i
                                    class="icon-heart"></i></NuxtLink>
                            <NuxtLink to="/#offcanvas-cart" class="bag offcanvas-toggle" data-number="3"><i
                                    class="icon-bag"></i><span>$20.00</span></NuxtLink>
                        </div>
                    ...
                    <div class="hero-side-category">
                        ...
                        <nav class="category-menu">
                            <ul>
                                ...
                                <li>
                                    <NuxtLink to="/#" id="more-btn"><i class="ion-ios-plus-empty" aria-hidden="true"></i> More
                                        Categories</NuxtLink>
                                </li>
                            </ul>
                        </nav>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <NuxtLink to="/single-product" class="image"><img src="~/assets/images/product-image/7.jpg"
                                alt="Cart product Image"></NuxtLink>
                        <div class="content">
                    ...
                    <li>
                        <NuxtLink to="/single-product" class="image"><img src="~/assets/images/product-image/9.jpg"
                                alt="Cart product Image"></NuxtLink>
                        <div class="content">
                    ...
                    <li>
                        <NuxtLink to="/single-product" class="image"><img src="~/assets/images/product-image/8.jpg"
                                alt="Cart product Image"></NuxtLink>
                        <div class="content">
    ...
    <div id="offcanvas-cart" class="offcanvas offcanvas-cart">
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <NuxtLink to="/single-product" class="image"><img src="~/assets/images/product-image/1.jpg"
                                alt="Cart product Image"></NuxtLink>
                        <div class="content">
                            <NuxtLink to="/single-product" class="title">Walnut Cutting Board</NuxtLink>
                            <span class="quantity-price">1 x <span class="amount">$100.00</span></span>
                    ...
                    <li>
                        <NuxtLink to="/single-product" class="image"><img src="~/assets/images/product-image/2.jpg"
                                alt="Cart product Image"></NuxtLink>
                        <div class="content">
                            <NuxtLink to="/single-product" class="title">Lucky Wooden Elephant</NuxtLink>
                            <span class="quantity-price">1 x <span class="amount">$35.00</span></span>
                    ...
                    <li>
                        <NuxtLink to="/single-product" class="image"><img src="~/assets/images/product-image/3.jpg"
                                alt="Cart product Image"></NuxtLink>
                        <div class="content">
                            <NuxtLink to="/single-product" class="title">Fish Cut Out Set</NuxtLink>
                            <span class="quantity-price">1 x <span class="amount">$9.00</span></span>
                ...
                <div class="col-md-8">
                    <div class="inner_complated">
                        ...
                        <div class="btn_cmpted">
                            <NuxtLink to="/shop-4-column" class="shop-btn" title="Go To Shop">Continue Shopping </NuxtLink>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-12">
                    <div class="main_quickorder text-align-center">
                        ...
                        <div class="cntct typewriter-effect"><span class="call_desk"><NuxtLink to="/tel:+01234567890" id="typewriter_num">01 234 567 890</NuxtLink></span></div>
                    </div>
                </div>
            </div>
        </div>
