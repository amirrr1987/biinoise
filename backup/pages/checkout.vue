                        ...
                        <div class="col-lg-5 mt-md-30px mt-lm-30px ">
                            <div class="your-order-area">
                                            ...
                                            <div class="panel-group" id="accordion">
                                                <div class="panel payment-accordion">
                                                    <div class="panel-heading" id="method-one">
                                                        <h4 class="panel-title">
                                                            <NuxtLink data-bs-toggle="collapse" data-parent="#accordion" to="/#method1">
                                                ...
                                                <div class="panel payment-accordion">
                                                    <div class="panel-heading" id="method-two">
                                                        <h4 class="panel-title">
                                                            <NuxtLink class="collapsed" data-bs-toggle="collapse" data-parent="#accordion" to="/#method2">
                                                                Check payments
                                                            </NuxtLink>
                                                        </h4>
                                                    </div>
                                                ...
                                                <div class="panel payment-accordion">
                                                    <div class="panel-heading" id="method-three">
                                                        <h4 class="panel-title">
                                                            <NuxtLink class="collapsed" data-bs-toggle="collapse" data-parent="#accordion" to="/#method3">
                                                                Cash on delivery
                                                            </NuxtLink>
                                                        </h4>
                                                    </div>
                                ...
                                <div class="Place-order mt-25">
                                    <NuxtLink class="btn-hover" to="/#">Place Order</NuxtLink>
                                </div>
                            </div>
                        </div>
                    </div>
