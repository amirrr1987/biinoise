                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="product-image-title">
                                                    <NuxtLink to="/#" class="image"><img class="img-responsive" src="~/assets/images/product-image/19.jpg" alt="Compare Product" /></NuxtLink>
                                                    <NuxtLink to="/#" class="category">Camera</NuxtLink>
                                                    <NuxtLink to="/#" class="title">Zeon Zen 4 Pro</NuxtLink>
                                                </td>
                                                <td class="product-image-title">
                                                    <NuxtLink to="/#" class="image"><img class="img-responsive" src="~/assets/images/product-image/24.jpg" alt="Compare Product" /></NuxtLink>
                                                    <NuxtLink to="/#" class="category">Doren</NuxtLink>
                                                    <NuxtLink to="/#" class="title">Aquet Doren D 420</NuxtLink>
                                                </td>
                                                <td class="product-image-title">
                                                    <NuxtLink to="/#" class="image"><img class="img-responsive" src="~/assets/images/product-image/10.jpg" alt="Compare Product" /></NuxtLink>
                                                    <NuxtLink to="/#" class="category">Games</NuxtLink>
                                                    <NuxtLink to="/#" class="title">Game Station X 22</NuxtLink>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="pro-addtocart">
                                                    <NuxtLink to="/#" class="add-to-cart" tabindex="0"><span>ADD TO CART</span></NuxtLink>
                                                </td>
                                                <td class="pro-addtocart">
                                                    <NuxtLink to="/#" class="add-to-cart" tabindex="0"><span>ADD TO CART</span></NuxtLink>
                                                </td>
