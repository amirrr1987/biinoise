                        ...
                        <div class="col-lg-3">
                            <div class="banner-area">
                                <div class="banner-wrapper mb-md-30px mb-lm-30px mb-sm-30px">
                                    <NuxtLink to="/shop-4-column"><img src="~/assets/images/banner-image/9.jpg" alt="" /></NuxtLink>
                                </div>
                                <div class="banner-wrapper mb-0px">
                                    <NuxtLink to="/shop-4-column"><img src="~/assets/images/banner-image/10.jpg" alt="" /></NuxtLink>
                                </div>
                            </div>
                        </div>
                    </div>
